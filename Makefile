...
build/game.out: game/sources/*.cpp
	g++ game/**/*.cpp engine/**/*.cpp -o build/game.out -lpthread -I include/ -I game/headers/ -I engine/headers/ -L lib/ -Wall -lglfw -lGL -ldl -lm -lstdc++ -lassimp

build/unit.out: tests/**/*.cpp
	g++ tests/**/*.cpp tests/*.cpp engine/**/*.cpp -o build/unit.out -lpthread -I include/ -I tests/headers/ -I engine/headers/ -L lib/ -Wall -lglfw -lGL -ldl -lm -lstdc++ -lassimp
