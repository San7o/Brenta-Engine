...
Engine::Engine(bool uses_screen, bool uses_audio, bool uses_input,
               ...
               int screen_width, int screen_height, bool screen_is_mouse_captured,
               ...
               bool gl_depth_test)
{
    if (uses_screen)
    {
        Screen::Init(screen_width, screen_height,
                        screen_is_mouse_captured, screen_title,
                        screen_msaa, screen_vsync);
        GL::LoadOpenGL(gl_blending, gl_cull_face,
...
Engine Engine::Builder::build()
{
    return Engine(uses_screen, uses_audio, uses_input, uses_logger, uses_text,
                    uses_ecs, screen_width, screen_height, screen_is_mouse_captured,
                    screen_msaa, screen_vsync, screen_title, log_level,
                    log_file, text_font, text_size, gl_blending, gl_cull_face,
                    gl_multisample, gl_depth_test);
}
