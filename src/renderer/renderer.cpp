...
tenno::vector<Renderer::Command> Renderer::transparent_render_queue = {};
tenno::vector<Text>                     Renderer::text_render_queue = {};
...
{
  if (transparent)
    Renderer::transparent_render_queue.push_back(it);
  else
...
{
  Renderer::text_render_queue.push_back(text);
}
...
void Renderer::flush_command(const Renderer::Command& command)
{
...
void Renderer::flush()
{
  ...
  Renderer::text_render_queue.clear();
